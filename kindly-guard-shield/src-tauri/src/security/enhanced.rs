//! Enhanced security pattern detection using kindly-guard-core
//!
//! This module provides advanced pattern matching and threat detection
//! using optimized algorithms from the core library.
...
pub struct EnhancedPatternDetector {
    ...
    unicode_normalizer: Arc<UnicodeNormalizer>,
...
impl EnhancedPatternDetector {
    ...
    /// Convert core threat type to our threat type
    fn convert_threat_type(core_type: kindly_guard_core::ThreatType) -> ThreatType {
        match core_type {
            kindly_guard_core::ThreatType::SqlInjection => ThreatType::SqlInjection,
            kindly_guard_core::ThreatType::XssAttempt => ThreatType::XssAttempt,
            kindly_guard_core::ThreatType::CommandInjection => ThreatType::CommandInjection,
            kindly_guard_core::ThreatType::PathTraversal => ThreatType::PathTraversal,
            kindly_guard_core::ThreatType::UnicodeExploit => ThreatType::UnicodeExploit,
...
mod tests {
    ...
    fn test_threat_type_conversion() {
        assert!(matches!(
            EnhancedPatternDetector::convert_threat_type(
                kindly_guard_core::ThreatType::SqlInjection
            ),
