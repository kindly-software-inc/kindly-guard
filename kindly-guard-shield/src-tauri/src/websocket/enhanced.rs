...
//!
//! This module provides optimized WebSocket handling using kindly-guard-core's
//! binary protocol for improved performance and reduced overhead.
...
use kindly_guard_core::{BinaryProtocol, MessageCompressor};
    ...
    pub fn new(enable_compression: bool) -> Result<Self> {
        ...
        let compressor = Arc::new(MessageCompressor::new(
            if enable_compression {
                kindly_guard_core::CompressionLevel::Fast
            } else {
                kindly_guard_core::CompressionLevel::None
            }
        ));
