...
use crate::protocol::{
    ...
    ResourceContentType, ResourceReadParams, ResourcesCapability, ResourcesListResult, ResponseId,
...
impl McpServer {
    ...
    async fn handle_request(&self, request: JsonRpcRequest) -> JsonRpcResponse {
        ...
        let result = match request.method.as_str() {
            ...
            "resources/read" => {
                self.handle_resources_read(request.params, &auth_context)
                    .await
            }
            ...
            "security/rate_limit_status" => {
                self.handle_rate_limit_status(request.params, &auth_context)
                    .await
            }
